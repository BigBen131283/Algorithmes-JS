...
// const differencesOneLiner = (arr1, arr2) => arr1.filter(el => !arr2.includes(el)).concat(arr2.filter(el => !arr1.includes(el)))
...
// console.log(differencesOneLiner([1, 2, 3, 5], [1, 2, 3, 4, 5]));     //  [ 4 ]
// console.log(differencesOneLiner(["x", "a", "c"], ["m","k","l"]));    //  [ 'x', 'a', 'c', 'm', 'k', 'l' ]
// console.log(differencesOneLiner([999,777], [777,444,111]));          //  [ 999, 444, 111 ]
