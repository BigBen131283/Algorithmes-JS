...
const getLongestWordCorrection = str => str.split(" ").reduce((acc, cur) => Math.max(acc, cur.length), 0)
...
console.log(getLongestWordCorrection("Du sublime au ridicule il n'y a qu'un pas.")); // 8
